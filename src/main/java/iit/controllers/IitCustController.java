...
public class IitCustController implements Initializable {
    @FXML
    ...
    //显示表格数据的方法
    private void showCustData( Cust custInfo, List<Event> allEvent) {
        CustData.addAll(custInfo);
    ...
    public void search() {
        ...
        allEvent = iitCustService.getAllEventsByPhone(keywords);
        allCustInfo = iitCustService.getAllCustsByPhone(keywords);
